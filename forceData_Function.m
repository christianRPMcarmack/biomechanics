function output = forceData_Function(file);
...
%   Plots
%% NOTES:
%   To run this program input the filenames of the trial data
%   For example: 
...
disp(' ')
output = [avgpeak2(1) avgv2(1) Imp2 ImpB2 ImpDiff numPks2 timeCont2 dutyF2 avgPullForce stdDev avgPullForce/numPks2];
end
